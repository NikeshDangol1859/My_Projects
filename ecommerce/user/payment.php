...
?>
    ...
    <div class="container ">
        ...
        <div class="row d-flex justify-contain-center align-items-center ">
            <div class="col-md-4">
            <a href="https://khalti.com/" target='_blank'><img src="../img/khalti.png" alt="" class="img1"></a>
            </div>
          
            <div class="col-md-4">
            <a href="https://esewa.com.np/" target='_blank'><img src="../img/esewa.png" alt="" class="img1"></a>
            </div>
